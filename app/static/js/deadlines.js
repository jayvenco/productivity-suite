...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // De mini-kalender in de sidebar stuurt dit event na het snel aanmaken van
  // een taak, zodat deze widget zonder page reload meteen mee-ververst.
  document.addEventListener("deadlines:refresh", loadDeadlines);
